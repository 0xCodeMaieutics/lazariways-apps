...
const exerciseSchema = z
  ...
  .superRefine((data, ctx) => {
    ...
    if (needsCorrectInputs && correctInputs.length === 0) {
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message: "At least one correct input is required (one per line)",
...
export function ExerciseForm({
  ...
  const needsAudio =
    watchedType === "CHOOSE_FROM_AUDIO" || watchedType === "INPUT_FROM_AUDIO"
  const needsOptions =
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle>{isEdit ? "Edit exercise" : "Create exercise"}</CardTitle>
      </CardHeader>
      <CardContent>
        <form
        ...
        >
          <FieldGroup>
            ...
            <Field>
              ...
              />
              <FieldDescription>
                Used for text-based types (CHOOSE_FROM_TEXT, INPUT_FROM_TEXT,
                etc.)
              </FieldDescription>
            ...
            {needsAudio ? (
              <>
                <Field>
                  <FieldLabel htmlFor="audioUrl">Audio URL</FieldLabel>
                  <div className="flex gap-2">
                    <Input
                      id="audioUrl"
                      placeholder="/audio/greetings/hallo.mp3"
                      disabled={isPending || generateAudioMutation.isPending}
                      {...register("audioUrl")}
                    />
                    <Button
                      type="button"
                  ...
                  <FieldError errors={[formState.errors.audioUrl]} />
                </Field>
                <Field>
                  <FieldLabel htmlFor="slowAudioUrl">Slow audio URL</FieldLabel>
                  <Input
                    id="slowAudioUrl"
                  ...
                  />
                  <FieldError errors={[formState.errors.slowAudioUrl]} />
                </Field>
              </>
            ) : null}
            {needsOptions ? (
              <>
                <Field>
                  ...
                  />
                  <FieldError errors={[formState.errors.optionsText]} />
                </Field>
                <Field>
                  <FieldLabel htmlFor="correctOptionIndexText">
                    Correct option index (0-based, comma-separated for multiple)
                  </FieldLabel>
                  <Input
                  ...
                  />
                  <FieldError
                    errors={[formState.errors.correctOptionIndexText]}
                  />
                </Field>
            ...
            {needsCorrectInputs ? (
              <Field>
                ...
                />
                <FieldError errors={[formState.errors.correctInputsText]} />
              </Field>
            ) : null}
          </FieldGroup>
          {error && (
