...
export const metadata: Metadata = {
  title: "პროფილი შექმნილია",
  description: "თქვენი პროფილი წარმატებით შეიქმნა.",
}

const WHATSAPP_NUMBER = "+4917632983291"
const WHATSAPP_MESSAGE =
  "გამარჯობა! Lazari Ways-ის ვებსაიტიდან პროფილი წარმატებით შევქმენი. ❤️"
    ...
    <main className="flex min-h-full flex-1 items-center justify-center p-6">
      <div className="mx-auto flex w-full flex-col items-center gap-4 text-center">
        <Image
          ...
          height={1080}
          priority
          className="mt-8 size-40 rounded-full object-cover ring-4 ring-primary/10"
        />
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            თქვენი პროფილი შეიქმნა. დამსაქმებლებთან საუბრის შემდეგ
            შეგეხმიანებით.
          </p>
        </div>
