...
export const applicationFormSchema = z.object({
  ...
  emergencyPhone: z.string().min(1, "საგანგებო ტელეფონის ნომერი სავალდებულოა"),
  workSector: z
...
export const adminApplicationEditSchema = applicationFormSchema
  ...
  .refine(
    ...
    {
      message: "Semester break end must be on or after semester break start",
      path: ["semesterBreakTo"],
    }
  )

export type AdminApplicationEditData = z.infer<
  typeof adminApplicationEditSchema
>
