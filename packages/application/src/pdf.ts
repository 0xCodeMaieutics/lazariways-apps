...
export const generateApplicationPdf = async (
  ...
  drawSection("Fähigkeiten & Eignung", [
    ...
    ["Weitere Sprachen", formatOptional(applicationFormData.otherLanguages)],
...
const generatePersonalGeorgienPdf = () => {
    // Fill "Praktische Erfahrung" with dummy data
    // "Praktische Erfahrung" example:
    /**
     * seit 09/2018 - Bäcker im Bereich Catering
     * Klüh Catering (Essen, DE)
     * Kundengerechte Verpackung und Auslieferung Herstellung von Feinbackwaren und Speiseeis nach
     * - Rezepturen
     * - Glasur und Verzierung von Torten nach
     * - Kundenwünschen
     * - Anfertigung von diversen Salaten und Snacks Regelmäßige Arbeit im Schichtdienst
     * 
     * seit 08/2016 bis 09/2018 - Bäcker im Bereich Warenanfertigung und Logistik
     * Bäckerei Dahlmann (Wuppertal, DE)
    */
}
