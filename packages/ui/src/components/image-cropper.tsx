      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-3">
          ...
          <div
            ref={viewportRef}
            role="presentation"
            className="relative mx-auto aspect-square w-full max-w-[min(85vw,280px)] touch-none overflow-hidden rounded-xl border-2 border-dashed border-primary/60 bg-muted select-none"
